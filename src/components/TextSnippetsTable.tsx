...
function TextSnippetsTable({ onAddClick, rows, onRowsChange, onEdit, onDuplicate, onDelete }: TextSnippetsTableProps) {
        ...
        <table className="text-snippets-table">
          <thead>
            <tr className="table-header-row">
              ...
              <th className="table-header-cell">Text Snippet</th>
              <th className="table-header-cell">User Access</th>
